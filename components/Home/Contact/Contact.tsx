...
const Contact = () => {
    return (
        <div className="pt-16 pb-16">
            <div
                className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto text-center lg:text-left"
                data-aos="fade-up"
                data-aos-duration="1000"
            >

                <h1
                    className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-100 leading-snug"
                    data-aos="fade-up"
                    data-aos-delay="100"
                >
                ...
                <p
                    className="text-gray-400 mt-6 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0"
                    data-aos="fade-up"
                    data-aos-delay="200"
                >
                ...
                <div
                    className="mt-7 space-y-4 flex flex-col items-center lg:items-start"
                    data-aos="fade-up"
                    data-aos-delay="300"
                >
                ...
                >
                    <a
                        ...
                        className="w-14 h-14 bg-blue-800 rounded-full flex items-center justify-center hover:bg-blue-900 transition-all duration-300"
                    >
                ...
                >
                    <a
                        ...
                        download
                        className="px-6 py-3 rounded-lg bg-blue-800 text-white font-semibold hover:bg-blue-900 transition-all duration-300 shadow-md"
                    >
                        Download Resume
                    </a>
                </div>
